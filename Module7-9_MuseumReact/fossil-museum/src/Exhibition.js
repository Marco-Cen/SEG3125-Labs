        ...
        <div className="exhibition">
            ...
            <div className="carnivoreFossilBkg">
                <div className="fossilInfoCard" style={{right:'0%'}}>
                    ...
                    {/* Video */}
                    <iframe width="412" height="330" src="https://www.youtube.com/embed/jIjIoAuNFNs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                   
                    </p>
            ...
            <div className="herbivoreBkg">
                <div className="fossilInfoCard">
                    ...
                    {/* Video */}
                    <iframe width="415" height="350" src="https://www.youtube.com/embed/gr2ZL70nCjs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </p>
